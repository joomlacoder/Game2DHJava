...
public class Player extends Entity {
    ...
    public Player(float x, float y, float scale, float speed, TextureAtlas atlas) {//Warning protected
    ...
    public void update(Input input) {
        ...
        if(newX <= 0) {
            newX = 0;
        }else if(newX >= Game.WEIDTH - SPRITE_SCALE * scale){
            newX = Game.WEIDTH - SPRITE_SCALE * scale;
        }
